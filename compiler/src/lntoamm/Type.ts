...
export class Type {
  ...
  static builtinTypes = {
    ...
    Function: new Type("Function", true, false, {
      argTypes: new Type("A", true, true),
      returnType: new Type("R", true, true),
    }, {
      A: 0,
      R: 1,
    }),
    Arg1: new Type("Arg1", true, false, {
      type1: new Type("A", true, true),
    }, {
      A: 0,
    }),
    Arg2: new Type("Arg2", true, false, {
      type1: new Type("A", true, true),
      type2: new Type("B", true, true),
    }, {
      A: 0,
      B: 1,
    }),
    Arg3: new Type("Arg3", true, false, {
      type1: new Type("A", true, true),
      type2: new Type("B", true, true),
      type3: new Type("C", true, true),
    }, {
      A: 0,
      B: 1,
      C: 2,
    }),
    Arg4: new Type("Arg4", true, false, {
      type1: new Type("A", true, true),
      type2: new Type("B", true, true),
      type3: new Type("C", true, true),
      type4: new Type("D", true, true),
    }, {
      A: 0,
      B: 1,
      C: 2,
    ...
    Arg5: new Type("Arg5", true, false, {
      type1: new Type("A", true, true),
      type2: new Type("B", true, true),
      type3: new Type("C", true, true),
      type4: new Type("D", true, true),
      type5: new Type("E", true, true),
    }, {
      A: 0,
      B: 1,
      C: 2,
    ...
    Arg6: new Type("Arg6", true, false, {
      type1: new Type("A", true, true),
      type2: new Type("B", true, true),
      type3: new Type("C", true, true),
      type4: new Type("D", true, true),
      type5: new Type("E", true, true),
      type6: new Type("F", true, true),
    }, {
      A: 0,
      B: 1,
      C: 2,
    ...
    Self: new Type("Self", true, false, {
      ...
      recurseFn: new Type("Function<Arg2<Self, any>, Result<anythingElse>>", true, false, {
        argTypes: new Type("Arg2<Self, any>", true, false, {
          type1: new Type("Self", true, true), // Will this work?
          type2: new Type('any', true, false, {}, {}, null, new Interface('any')),
        }),
        returnType: new Type("Result<anythingElse>", true, false, {
          value: new Type('anythingElse', true, false, {}, {}, null, new Interface('anythingElse')),
          error: new Type("Error", true, false, {
            msg: new Type("string", true, true),
          }),
        }),
