...
Type.builtinTypes.Function.solidify(['void', 'any'], opcodeScope)
Type.builtinTypes.Function.solidify(['Arg2<any, int64>', 'void'], opcodeScope)
Type.builtinTypes.Function.solidify(['Arg2<any, int64>', 'anythingElse'], opcodeScope)
Type.builtinTypes.Function.solidify(['Arg2<any, any>', 'any'], opcodeScope)
Type.builtinTypes.Function.solidify(['Arg2<anythingElse, any>', 'anythingElse'], opcodeScope)
Type.builtinTypes.Function.solidify(['Arg1<any>', 'bool'], opcodeScope)
Type.builtinTypes.Function.solidify(['Arg1<int64>', 'void'], opcodeScope)
Type.builtinTypes.Function.solidify(['void', 'bool'], opcodeScope)
Type.builtinTypes.Function.solidify(['void', 'void'], opcodeScope)
Type.builtinTypes.Function.solidify(['Arg2<Self, any>', 'Result<anythingElse>'], opcodeScope)
