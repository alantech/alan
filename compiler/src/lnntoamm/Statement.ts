...
//   // transform(metadata: StatementMetaData): void;
// }
...
//   constructor(
//     upstream: StatementMetaData = null,
//     vars: {[name: string]: VarMetadata} = {},
//   ) {
//     this.outputConstraints = [];
//     this.vars = vars;
//     if (upstream !== null) {
//       this.__upstream = new StatementMetaData();
//       // shallow clone the statement metadata. It's unlikely that the actual
//       // values in the original upstream will be modified, but we want to
//       // preserve only the values that have already been defined by the time
//       // this closure or inlined fn has been metadata'd.
//       for (let upstreamVar of Object.keys(upstream)) {
//         this.__upstream.vars[upstreamVar] = upstream[upstreamVar];
//       }
//     }
//   }
...
//           const decOrVar = this.metadata.var(assignable.get('variable').t).dec.ref();
//           split.push(new Statement(decOrVar.ast, decOrVar));
//         }
...
//   ) {
//     call = call.get('assignablelist');
//     let argDecs = [
//       call.get('assignables'),
//       ...call.get('cdr').getAll().map(a => a.get('assignables')),
...
//     console.log('~~~~~~~~~~~~~~~~~~~~~~~', split.slice(snapshot));
//   }
// }
...
//     final: Stmt | null = null,
//   ) {
//     if (final instanceof Assignable) {
//       throw new Error('did not expect Assignable final value');
//     }
...
//   static generate(final: Stmt | null, assignable: Assignable = null): Declaration {
//     // const _abc123 = final;
//     return new Declaration(
//       (final !== null ? final : assignable).ast,
//       false,
//       genName(),
//       null,
//       assignable,
...
//       return final;
//     } else if (final instanceof Assignable) {
//       return this.generate(null, final);
//     }
...
//       console.log('generated declaration, skipping split because final is', this.final);
...
//     if (metavar === null) {
//       metavar = new VarMetadata(this);
//       metadata.vars[this.name] = metavar;
//     } else if (metavar.dec !== this) {
...
//       throw new Error(`invalid declaration state (already defined)`);
//     }
//     metavar.constraints.push(this.final.getOutputType());
//   }
...
// export class Arg extends Declaration {
//   constructor(
//     node: LPNode,
//     name: string,
//     ty: Type,
//     metadata: StatementMetaData,
//   ) {
//     super(node, true, name, ty, null, null);
//     metadata.vars[name] = new VarMetadata(this)
//   }

//   split(): Statement[] {
//     return [new Statement(this.ast as LPNode, this)];
//   }
